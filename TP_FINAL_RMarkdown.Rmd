...
```
**Figura 3:** Respecto a la proporcion de PER en cada tiempo de evaluacion en cada semana, se observa cierto grado de variabilidad en las respuestas. Resulta conveniente incluirla como variable explicatoria del modelo.
...
```
**Figura 4:** REDACTARSE UN EPIGRAFE PIOLA DE ESTO
