...
Para evaluar el aprendizaje en la etapa de entrenamiento se realizó un análisis descriptivo porque interesa saber cualitativamente si hay una tendencia de aprendizaje en todas las abejas. Se sabe por otros estudios MILIII que el protocolo realizado logra un aprendizaje efectivo.
