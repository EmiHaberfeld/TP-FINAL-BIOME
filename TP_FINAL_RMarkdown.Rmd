...
author: "Matías Alemán, Milagros Azcueta, Manuel Fiz, Emilia Haberfeld, Diego Kafer, \nJuan Francisco Robuschi, Ilán Shalom, Rodrigo Villarreal"
output: pdf_document
editor_options: 
...
![](dispositivo_experimental.jpg)
**Figura 1:** dispositivo experimental. MILI O MATI DESCRIBAN ESTA.

![](linea_de_tiempo.jpg)
**Figura 2:** diseño experimental MILI VENÍ A CHECKEAR ESTA
...
Para evaluar el aprendizaje en la etapa de entrenamiento se realizó un análisis descriptivo porque interesa saber cualitativamente si todas hay una tendencia de aprendizaje en todas las abejas. Se sabe por otros estudios MILIII que el protocolo realizado logra un aprendizaje efectivo.
...
................. ESCRIBIR ALGO SOBRE POR QUÉ HACEMOS DESCRIPTIVA DE SEMANA
...
Como se observa variabilidad en las respuestas entre semanas, resulta conveniente incluir la variable "semana" como variable explicatoria del modelo para tener una mayor variabilidad explicada.
