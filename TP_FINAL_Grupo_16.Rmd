...
Como la variable respuesta es dicotómica (extensión o no de la probóscide), se espera una distribución de probabilidades de Bernoulli. Por lo tanto, se utilizará un modelo lineal generalizado para modelarla. En particular, una regresión logística. El diseño experimental es de medidas repetidas porque cada abeja fue medida repetidas veces a lo largo del tiempo (3 veces en la etapa de evaluación).
...
- Semana de trabajo: cualitativa fija de 7 niveles (semanas 1 a 7). Covariable.

Como todas las variables explicativas son cualitativas, optamos por expresar el modelo como una comparación de medias.
